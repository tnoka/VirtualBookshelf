                    ...
                    <div class="col-md-8 mb-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ url('products/' .$timeline->id) }}"><img src="{{ asset('https://s3-ap-northeast-1.amazonaws.com/virtualbookshelf/' .$timeline->product_image) }}"  alt="" width="300" height="300" class="mt-4 d-block mx-auto img-fluid img-responsive thumbnail aligncenter size-full"></a>
